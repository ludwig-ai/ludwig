...
class LightGBMTrainer(Trainer):
    def train(self, training_set, validation_set=None, test_set=None, save_path="model", **kwargs):
        ...
        features_names = list(self.model.input_features.keys())
        ...
        (train_metrics, vali_metrics, test_metrics) = self.initialize_training_metrics(self.model.output_features)
        ...
        return self.model, train_metrics, vali_metrics, test_metrics
