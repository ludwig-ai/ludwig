...
class KDDCup2009Loader(DatasetLoader):
    def __init__(
        self, config: DatasetConfig, cache_dir: str = DEFAULT_CACHE_LOCATION, task_name="", include_test_download=False
    ):
...
class KDDAppetencyLoader(KDDCup2009Loader):
    ...
    def __init__(self, config: DatasetConfig, cache_dir=DEFAULT_CACHE_LOCATION, include_test_download=False):
        super().__init__(
