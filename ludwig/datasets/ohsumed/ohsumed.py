...
class OhsuMed(BaseDataset):
    ...
    def process(self) -> None:
        if super().check_file_existence(self._cur_version, "ohsumed", "raw.csv"):
            ...
            raise FileNotFoundError("The raw dataset for ohsumed was not found")
        try:
    ...
    def load(self) -> pd.DataFrame:
        ...
        if super().check_file_existence(self._cur_version, "ohsumed", "processed.csv"):
