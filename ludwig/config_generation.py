        ...
        return json.dumps(
            {
                ...
                "input_feature_types": ["number", "category", "binary", "text", "image", "audio", "sequence", "set",
                                        "vector", "timeseries", "date", "h3", "bag"],
                "output_feature_types": ["number", "category", "binary", "text", "sequence", "set", "vector"],
                "combiner_types": ["concat", "transformer", "ft_transformer", "cross_attention", "perceiver",
                                   "gated_fusion", "tabnet", "tabtransformer", "comparator", "project_aggregate",
                                   "sequence", "sequence_concat"],
                "encoder_types_number": ["passthrough", "dense", "ple", "periodic"],
                "encoder_types_category": ["dense", "sparse", "onehot", "passthrough"],
                "encoder_types_text": ["auto_transformer", "bert", "gpt2", "parallel_cnn", "stacked_cnn",
                                       "stacked_parallel_cnn", "rnn", "cnnrnn", "transformer"],
