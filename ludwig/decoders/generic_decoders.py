...
from ludwig.constants import BINARY, CATEGORY, CATEGORY_PROB, LOSS, NUMBER, SET, TIMESERIES, TYPE, VECTOR
...
@DeveloperAPI
@register_decoder("classifier", [CATEGORY, CATEGORY_PROB, SET])
