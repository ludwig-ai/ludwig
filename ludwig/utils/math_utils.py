...
def exponential_decay(
    initial_learning_rate, decay_rate, decay_steps, step, staircase=False
):
...
def learning_rate_warmup_distributed(
    learning_rate, epoch, warmup_epochs, num_workers, curr_step, steps_per_epoch
):
...
def learning_rate_warmup(
    learning_rate, epoch, warmup_epochs, curr_step, steps_per_epoch
):
    if epoch >= warmup_epochs:
        return learning_rate
    else:
