...
from ludwig.features.binary_feature import (
    BinaryFeatureMixin,
    BinaryInputFeature,
    BinaryOutputFeature,
)
...
from ludwig.features.numerical_feature import (
    NumericalFeatureMixin,
...
from ludwig.features.set_feature import (
    SetFeatureMixin,
    SetInputFeature,
    SetOutputFeature,
)
from ludwig.features.text_feature import (
    TextFeatureMixin,
    TextInputFeature,
    TextOutputFeature,
)
from ludwig.features.timeseries_feature import (
    TimeseriesFeatureMixin,
    TimeseriesInputFeature,
)
from ludwig.features.vector_feature import (
    VectorFeatureMixin,
    VectorInputFeature,
    VectorOutputFeature,
)
...
def update_config_with_metadata(config, training_set_metadata):
    ...
    for input_feature in config["input_features"]:
        ...
        feature.update_config_with_metadata(
            input_feature, training_set_metadata[input_feature[NAME]], config=config
        )
