...
class SequenceInputFeature(SequenceFeatureMixin, InputFeature):
    ...
    def output_shape(self) -> torch.Size:
        ...
        # generate dummy input tensor of ints to pass through forward() method
        input_tensor = torch.zeros((2, *self.input_shape), dtype=torch.int32)
        output_tensor = self.forward(input_tensor)

        # output_tensor is a dictionary with keys:
        #   encoder_output: tensor generated by encoder
        #   length: length of the generated sequences
