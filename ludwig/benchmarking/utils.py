...
from ludwig.globals import CONFIG_YAML, MODEL_FILE_NAME, MODEL_WEIGHTS_FILE_NAME, MODEL_WEIGHTS_SAFETENSORS_FILE_NAME
...
def delete_model_checkpoints(output_directory: str):
    ...
    for weights_name in (MODEL_WEIGHTS_SAFETENSORS_FILE_NAME, MODEL_WEIGHTS_FILE_NAME):
        weights_path = os.path.join(output_directory, MODEL_FILE_NAME, weights_name)
