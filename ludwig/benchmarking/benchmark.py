...
def benchmark_one_local(experiment: Dict[str, str], export_artifacts_dict: Dict[str, Union[str, bool]]) -> None:
    ...
    ludwig_experiment_with_benchmarks(model, training_set=train_df, validation_set=val_df, test_set=test_df,
    ...
    if export_artifacts_dict["export_artifacts"]:
        export_artifacts(experiment, report_path, experiment_output_directory,
                         export_artifacts_dict["export_base_path"])
