...
# If `use_torch_profiler=True` in LudwigProfiler, this tag is prepended to the specified experiment tag
# (LudwigProfiler(tag="...", ..)) in the backend so that we can retrieve events of torch ops for this tag.
LUDWIG_TAG = "[ludwig]"