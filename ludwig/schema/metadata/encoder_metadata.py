...
ENCODER_METADATA = {
    ...
    "MLPMixerEncoder": {
        ...
        "requires_equal_dimensions": ParameterMetadata(
            ui_display_name="Requires Equal Dimensions",
            default_value_reasoning="MLPMixerEncoder doesn't require image width and height to be equal",
            example_value=[True, False],
            related_parameters=["width", "height"],
            other_information=None,
            description_implications=None,
            suggested_values=[False],
            suggested_values_reasoning="MLPMixerEncoder doesn't require image width and height to be equal",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=None,
            internal_only=True,
        ),
        "required_width": ParameterMetadata(
            ui_display_name="Required Image Width",
            default_value_reasoning="MLPMixerEncoder isn't a pretrained encoder",
            example_value=None,
            related_parameters=["width"],
            other_information=None,
            description_implications=None,
            suggested_values=None,
            suggested_values_reasoning="MLPMixerEncoder isn't a pretrained encoder",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=None,
            internal_only=True,
        ),
        "required_height": ParameterMetadata(
            ui_display_name="Required Image Width",
            default_value_reasoning="MLPMixerEncoder isn't a pretrained encoder",
            example_value=None,
            related_parameters=["height"],
            other_information=None,
            description_implications=None,
            suggested_values=None,
            suggested_values_reasoning="MLPMixerEncoder isn't a pretrained encoder",
    ...
    "ResNetEncoder": {
        ...
        "requires_equal_dimensions": ParameterMetadata(
            ui_display_name="Requires Equal Dimensions",
            default_value_reasoning="ResNetEncoder doesn't require image width and height to be equal",
            example_value=[True, False],
            related_parameters=["wdith", "height"],
            other_information=None,
            description_implications=None,
            suggested_values=[False],
            suggested_values_reasoning="ResNetEncoder doesn't require image width and height to be equal",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=None,
            internal_only=True,
        ...
        "required_width": ParameterMetadata(
            ui_display_name="Required Image Width",
            default_value_reasoning="ResNetEncoder isn't a pretrained encoder",
            example_value=None,
            related_parameters=["width"],
            other_information=None,
            description_implications=None,
            suggested_values=None,
            suggested_values_reasoning="ResNetEncoder isn't a pretrained encoder",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=None,
            internal_only=True,
    ...
    "Stacked2DCNN": {
        ...
        "requires_equal_dimensions": ParameterMetadata(
            ui_display_name="Requires Equal Dimensions",
            default_value_reasoning="Stacked2DCNN doesn't require image width and height to be equal",
            example_value=[True, False],
            related_parameters=["width", "height"],
            other_information=None,
            description_implications=None,
            suggested_values=[False],
            suggested_values_reasoning="Stacked2DCNN doesn't require image width and height to be equal",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=None,
            internal_only=True,
        ...
        "required_width": ParameterMetadata(
            ui_display_name="Required Image Width",
            default_value_reasoning="Stacked2DCNN isn't a pretrained encoder",
            example_value=None,
            related_parameters=["width"],
            other_information=None,
            description_implications=None,
            suggested_values=None,
            suggested_values_reasoning="Stacked2DCNN isn't a pretrained encoder",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=None,
            internal_only=True,
    ...
    "ViTEncoder": {
        ...
        "requires_equal_dimensions": ParameterMetadata(
            ui_display_name="Requires Equal Dimensions",
            default_value_reasoning="Each image is split into a sequence of fixed-size non-overlapping patches, which "
            "are then linearly embedded. To do this correctly, ViT encoder requires images with the same width and "
            "height to create patches of equal dimension. ",
            example_value=True,
            related_parameters=["width", "height"],
            other_information=None,
            description_implications=None,
            suggested_values=[True],
            suggested_values_reasoning="Each image is split into a sequence of fixed-size non-overlapping patches, "
            "which are then linearly embedded. To do this correctly, ViT encoder requires images with the same width "
            "and height to create patches of equal dimension. ",
            commonly_used=False,
            expected_impact=ExpectedImpact.MEDIUM,
            literature_references=["https://arxiv.org/pdf/2010.11929.pdf"],
            internal_only=True,
        ),
        "required_width": ParameterMetadata(
            ui_display_name="Required Image Width",
            default_value_reasoning="If a pretrained ViT encoder is being used, images must have a width of 224",
            example_value=224,
            related_parameters=["width"],
            other_information=None,
            description_implications=None,
            suggested_values=224,
            suggested_values_reasoning="If a pretrained ViT encoder is being used, images must have a width of 224",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=["https://arxiv.org/pdf/2010.11929.pdf"],
            internal_only=True,
        ...
        "required_height": ParameterMetadata(
            ui_display_name="Required Image Height",
            default_value_reasoning="If a pretrained ViT encoder is being used, images must have a height of 224",
            example_value=224,
            related_parameters=["height"],
            other_information=None,
            description_implications=None,
            suggested_values=224,
            suggested_values_reasoning="If a pretrained ViT encoder is being used, images must have a height of 224",
            commonly_used=False,
            expected_impact=ExpectedImpact.LOW,
            literature_references=["https://arxiv.org/pdf/2010.11929.pdf"],
            internal_only=True,
