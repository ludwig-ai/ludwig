...
ENCODER_METADATA = {
    "ALBERTEncoder": {
        ...
        "hidden_act": ParameterMetadata(
            ...
            literature_references=[
                ...
                "https://huggingface.co/docs/transformers/model_doc/albert#transformers"
                ".AlbertConfig.hidden_act) "
                "[Relevant StackOverflow discussion]("
                "https://ai.stackexchange.com/questions/30341/why-does-a-transformer-not-use-an"
                "-activation-function-following-the-multi-head-a) "
            ],
            internal_only=False,
        ),
    ...
    "BagEmbedWeightedEncoder": {
        ...
        "norm_params": ParameterMetadata(
            ...
            expected_impact=ExpectedImpact.LOW,
            literature_references=[
                "For BatchNorm2d: https://arxiv.org/abs/1502.03167" "For LayerNorm: https://arxiv.org/abs/1607.06450"
            ],
            internal_only=False,
        ),
    ...
    "ViTEncoder": {
        ...
        "hidden_act": ParameterMetadata(
            ...
            expected_impact=ExpectedImpact.MEDIUM,
            literature_references=[
                "[Huggingface docs for ViT config](https://huggingface.co/docs/transformers/model_doc/vit"
                "#transformers.ViTConfig.hidden_act) "
                "[Relevant StackOverflow discussion]("
                "https://ai.stackexchange.com/questions/30341/why-does-a-transformer-not-use-an-activation-function"
                "-following-the-multi-head-a) "
            ],
        ...
        "trainable": ParameterMetadata(
            ...
            expected_impact=ExpectedImpact.MEDIUM,
            literature_references=[
                "https://www.ibm.com/cloud/learn/overfitting" "http://d2l.ai/chapter_computer-vision/fine-tuning.html"
            ],
            internal_only=False,
        ),
        "use_pretrained": ParameterMetadata(
