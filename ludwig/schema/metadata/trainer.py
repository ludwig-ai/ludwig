...
checkpoints_per_epoch_metadata = {
    "allow_none": False,
    "default_value": False,
...
evaluate_training_set_metadata = {
    "allow_none": False,
    "default_value": True,
...
gradient_clipping_metadata = {
    "allow_none": True,
    "default_value": {"clipglobalnorm": 0.5},
    "ui_display_name": "Gradient Clipping",
    "type_annotation": None,
    "description": "Parameter values for gradient clipping.",
    "default_value_reasoning": "A conservative cap on the maximum gradient size to apply over a single training step.",
...
increase_batch_size_eval_metric_metadata = {
    "allow_none": False,
    "default_value": "loss",
...
increase_batch_size_eval_split_metadata = {
    "allow_none": False,
...
increase_batch_size_on_plateau_metadata = {
    "allow_none": False,
    "default_value": False,
...
increase_batch_size_on_plateau_max_metadata = {
    "allow_none": False,
    "default_value": 512.0,
...
increase_batch_size_on_plateau_patience_metadata = {
    "allow_none": False,
    "default_value": 5.0,
...
increase_batch_size_on_plateau_rate_metadata = {
    "allow_none": False,
    "default_value": 2.0,
...
learning_rate_scaling_metadata = {
    "allow_none": False,
...
learning_rate_warmup_epochs_metadata = {
    "allow_none": False,
    "default_value": True,
...
reduce_learning_rate_eval_metric_metadata = {
    "allow_none": False,
    "default_value": "loss",
...
reduce_learning_rate_eval_split_metadata = {
    "allow_none": False,
    "default_value": "training",
...
reduce_learning_rate_on_plateau_metadata = {
    "allow_none": False,
    "default_value": False,
...
reduce_learning_rate_on_plateau_patience_metadata = {
    "allow_none": False,
    "default_value": 5.0,
...
reduce_learning_rate_on_plateau_rate_metadata = {
    "allow_none": False,
    "default_value": 0.5,
...
regularization_lambda_metadata = {
    "allow_none": False,
    "default_value": False,
...
steps_per_checkpoint_metadata = {
    ...
    "default_value_reasoning": "By default, we evaluate once per epoch, which scales according to the dataset size.",
    "schema": "min: 0",
    "example_value": None,
