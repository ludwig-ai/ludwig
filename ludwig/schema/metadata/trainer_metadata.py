    ...
    {'batch_size': ParameterMetadata(ui_display_name='Batch Size',
     ...
     'epochs': ParameterMetadata(ui_display_name='Epochs',
                                 ...
                                 suggested_values_reasoning="Usually it's sensible to leave this very high and rely "
                                                            "on a "
                                                            'solid early stopping policy to dictate when the model '
                                                            'should '
                                                            'stop training. Some models and hyperparameter '
                                                            'configurations '
     ...
     'eval_batch_size': ParameterMetadata(ui_display_name='Evaluation Batch Size',
                                          ...
                                          other_information='Should only set the batch_size to a level that you can '
                                                            'fit in '
                                                            'memory',
                                          description_implications='By increasing the `eval_batch_size` past the '
                                                                   '`batch_size` parameter set value, you allow for '
                                                                   'more '
                                                                   'parallelism in the batch evaluation step. For '
                                                                   'example, '
                                                                   'if you have to evaluate the model on a test set of '
                                                                   'size 1000, it is faster to evaluate two times '
                                                                   'with two '
                                                                   'batches of size 500 as opposed to ten times with '
                                                                   'ten '
                                                                   'batches of 100. Setting this parameter higher '
                                                                   'without '
                                                                   'maxing out memory limits will speed up the model '
                                                                   'training process overall.',
                                          suggested_values=(256, 512, 1024),
                                          suggested_values_reasoning='By observing memory consumption on training '
                                                                     'jobs, '
                                                                     'you can get a sense of how much extra memory is '
                                                                     'available for increasing this value. A good '
                                                                     'rule of '
                                                                     'thumb can be experimentally doubling the eval '
                                                                     'batch '
                                                                     'size if you do not have insight into memory '
                                                                     'usage.',
                                          commonly_used=False,
                                          expected_impact=ExpectedImpact.MEDIUM,
                                          literature_references=None,
     ...
     'evaluate_training_set': ParameterMetadata(ui_display_name='Evaluate Training Set',
                                                default_value_reasoning='It could be useful to monitor evaluation '
                                                                        'metrics '
                                                                        'on the training set, as a secondary '
                                                                        'validation '
                                                                        'set.',
                                                example_value=None,
                                                ...
                                                description_implications='Running evaluation on the full training set, '
                                                                         'when your training set is large, '
                                                                         'can be a huge '
                                                                         'computational cost. Turning off training set '
                                                                         'evaluation will lead to significant gains in '
                                                                         'training throughput and efficiency. For '
                                                                         'small '
                                                                         'datasets that train and evaluate quickly, '
                                                                         'the '
                                                                         'choice is trivial.',
     ...
     'gradient_clipping': ParameterMetadata(ui_display_name='Gradient Clipping',
                                            default_value_reasoning='A conservative cap on the maximum gradient size '
                                                                    'to '
                                            ...
                                            description_implications='Gradient clipping is a technique to prevent '
                                                                     ...
                                                                     'training loss curve stability, but it can also '
                                                                     'make '
                                                                     'training less efficient as weight at each '
                                                                     'training '
                                                                     'step is capped.',
                                            suggested_values=None,
                                            suggested_values_reasoning="It's usually sensible to have some "
                                                                       "conservative "
     ...
     'learning_rate': ParameterMetadata(ui_display_name='Learning Rate',
                                        ...
                                        related_parameters=None,
                                        other_information=None,
                                        description_implications='The learning rate is a hyperparameter that controls '
                                                                 'how '
                                                                 'much to change the model in response to the '
                                                                 'estimated '
                                                                 'error each time the model weights are updated. '
                                                                 'Increasing the learning rate may decrease learning '
                                                                 'curve '
                                                                 'stability but also increase learning speed and '
                                                                 'efficiency, leading to faster model convergence. '
                                                                 'Decreasing the learning rate can help stabilize '
                                                                 'learning '
                                        ...
                                        suggested_values_reasoning='Tabular models trained from scratch typically use '
                                                                   'learning rates around 1e-3 while learning rates '
                                                                   'for '
                                                                   'pre-trained models should be much smaller, '
                                                                   'typically '
                                                                   'around 1e-5, which is important to mitigate '
                                                                   'catastrophic forgetting. To make the model more '
                                                                   'robust '
     ...
     'learning_rate_scaling': ParameterMetadata(ui_display_name='Learning Rate Scaling',
                                                default_value_reasoning='Traditionally the learning rate is scaled '
                                                                        'linearly with the number of workers to '
                                                                        'reflect '
                                                ...
                                                description_implications='Traditionally the learning rate is scaled '
                                                                         ...
                                                                         'softer square-root scale can sometimes lead '
                                                                         'to '
                                                                         'better model performance. If the learning '
                                                                         'rate '
                                                                         'is hand-tuned for a given number of workers, '
                                                                         'setting this value to constant can be used '
                                                                         'to '
                                                                         'disable scale-up.',
                                                ...
                                                suggested_values_reasoning='Traditionally the learning rate is scaled '
                                                                           'linearly with the number of workers to '
                                                                           'reflect '
                                                                           'the proportion by which the effective '
                                                                           'batch '
                                                                           'size is increased. For very large batch '
                                                                           'sizes, '
                                                                           'a softer square-root scale can sometimes '
                                                                           'lead '
                                                                           'to better model performance. If the '
                                                                           'learning '
                                                                           'rate is hand-tuned for a given number of '
                                                                           'workers, setting this value to constant '
                                                                           'can be '
     ...
     'learning_rate_warmup_epochs': ParameterMetadata(ui_display_name='Learning Rate Warmup Epochs',
                                                      default_value_reasoning='The randomness of how weights are '
                                                                              'initialized can result in strange, '
                                                                              'noisy '
                                                                              'gradient updates during the begining of '
                                                                              'your training run. Learning rate '
                                                                              'warmup has '
                                                                              'the benefit of slowly starting to tune '
                                                                              'things like attention mechanisms in '
                                                                              'your '
                                                                              'network, that may be prone to bad '
                                                                              'initial '
                                                                              'conditions.',
                                                      example_value=None,
                                                      related_parameters=None,
                                                      ...
                                                      description_implications='Learning rate warmup sets a very low '
                                                                               'learning rate for a set number of '
                                                                               'training '
                                                                               'steps (warmup steps). After your '
                                                                               'warmup '
                                                                               'steps you use your "regular" learning '
                                                                               'rate '
                                                                               'or learning rate scheduler. You can '
                                                                               'also '
                                                                               'gradually increase your learning rate '
                                                                               'over '
                                                                               'the number of warmup steps.',
                                                      suggested_values=True,
                                                      suggested_values_reasoning="You don't want to warm up for too "
                                                                                 "long, "
                                                                                 'as after the model is starting to '
                                                                                 'hill '
                                                                                 'climb, you want to use the full '
                                                                                 'weight '
     ...
     'optimizer': ParameterMetadata(ui_display_name='Optimizer',
                                    ...
                                    related_parameters=None,
                                    other_information=None,
                                    description_implications='Choosing a good optimizer for your machine learning '
                                                             'project '
                                                             'can be overwhelming. Popular deep learning libraries '
                                                             'such as '
                                                             'PyTorch or TensorFLow offer a broad selection of '
                                                             'different '
                                                             'optimizers — each with its own strengths and weaknesses. '
                                                             'However, picking the wrong optimizer can have a '
                                                             'substantial '
                                                             'negative impact on the performance of your machine '
                                                             'learning '
                                                             'model [1][2]. This makes optimizers a critical design '
                                                             'choice '
                                                             'in the process of building, testing, and deploying your '
                                                             'machine learning model.',
                                    suggested_values='adam, adamw',
                                    suggested_values_reasoning='As a rule of thumb: If you have the resources to find '
                                                               'a '
                                                               'good learning rate schedule, SGD with momentum is a '
                                                               'solid '
     ...
     'regularization_lambda': ParameterMetadata(ui_display_name='Regularization Lambda',
                                                default_value_reasoning='How to tune the overall impact of the '
                                                                        'regularization term by multiplying its value '
                                                                        'by a '
                                                ...
                                                description_implications='When choosing a lambda value, the goal is to '
                                                                         'strike the right balance between simplicity '
                                                                         'and '
                                                                         'training-data fit:\n'
                                                                         '\n'
                                                                         'If your lambda value is too high, your model '
                                                                         'will be simple, but you run the risk of '
                                                                         "underfitting your data. Your model won't "
                                                                         "learn "
                                                                         'enough about the training data to make '
                                                                         'useful '
                                                                         'predictions.\n'
                                                                         '\n'
                                                                         'If your lambda value is too low, '
                                                                         'your model will '
                                                                         'be more complex, and you run the risk of '
                                                                         'overfitting your data. Your model will '
                                                                         'learn too '
                                                                         'much about the particularities of the '
                                                                         'training '
                                                                         "data, and won't be able to generalize to new "
                                                                         'data. The ideal value of lambda produces a '
                                                                         'model '
                                                                         'that generalizes well to new, previously '
                                                                         'unseen '
     ...
     'regularization_type': ParameterMetadata(ui_display_name='Regularization Type',
                                              default_value_reasoning='L2 is a sufficiently good regularization to '
                                                                      'start '
                                                                      'with.',
                                              example_value=None,
                                              related_parameters=['regularization_lambda'],
                                              other_information=None,
                                              description_implications='L1 regularization penalizes the sum of '
                                                                       'absolute '
                                                                       'values of the weights, whereas L2 '
                                                                       'regularization '
                                                                       'penalizes the sum of squares of the weights. \n'
                                                                       'The L1 regularization solution is sparse. The '
                                                                       'L2 '
                                                                       ...
                                                                       'values near 0 instead of 0. L1 regularization '
                                                                       'has '
                                              ...
                                              literature_references=[
                                                  ...
                                                  '-regularization#:~:text=The%20differences%20between%20L1%20and,'
                                                  'regularization%20solution%20is%20non%2Dsparse. '
                                              ],
                                              internal_only=False),
     'should_shuffle': ParameterMetadata(ui_display_name='Should Shuffle',
                                         ...
                                         description_implications='Turning off mini-batch shuffling can make training '
                                                                  'faster, but it may lead to worse performance '
                                                                  'overall as '
                                                                  'shuffling helps mitigate overfitting.',
                                         suggested_values=True,
                                         suggested_values_reasoning='One of the most powerful things about neural '
                                                                    'networks '
                                                                    'is that they can be very complex functions, '
                                                                    'allowing '
                                                                    'one to learn very complex relationships between '
                                                                    'your '
                                                                    'input and output data. These relationships can '
                                                                    'include things you would never expect, '
                                                                    'such as the '
                                                                    'order in which data is fed in per epoch. If the '
                                                                    'order '
                                                                    'of data within each epoch is the same, '
                                                                    'then the model '
                                                                    'may use this as a way of reducing the training '
                                                                    'error, '
                                         ...
                                         literature_references=[
                                             ...
                                             '-data'
                                             '-while-training-a-neural-network#:~:text=it%20helps%20the%20training'
                                             '%20converge,the%20order%20of%20the%20training '
                                         ],
                                         internal_only=False),
     'staircase': ParameterMetadata(ui_display_name='Staircase',
                                    default_value_reasoning='Extra knob for decaying the learning rate in a different '
                                                            'way.',
                                    example_value=None,
                                    related_parameters=None,
                                    other_information=None,
                                    description_implications='An excessively aggressive decay results in optimizers '
                                                             'never '
                                                             'reaching the minima, whereas a slow decay leads to '
                                                             'chaotic '
                                                             'updates without significant improvement. Discrete '
                                                             'learning '
                                                             'rate decay is another knob to help tune a balance.',
                                    suggested_values=False,
                                    suggested_values_reasoning='We have not found strong evidence that discretely '
                                                               'decaying '
                                                               'the learning rate is superior to doing so '
                                                               'continuously.',
                                    commonly_used=False,
                                    expected_impact=ExpectedImpact.LOW,
                                    literature_references=[
     ...
     'steps_per_checkpoint': ParameterMetadata(ui_display_name='Steps Per Checkpoint',
                                               ...
                                               description_implications='Epoch-based evaluation (using the default: '
                                                                        ...
                                                                        '\n'
                                                                        'However, this is a poor fit for unstructured '
                                                                        'datasets, which tend to be much larger, '
                                                                        'and train '
                                                                        'more slowly due to larger models.\n'
                                                                        '\n'
                                                                        "It's important to setup evaluation such that "
                                                                        "you "
                                                                        'do not wait several hours before getting a '
                                                                        'single '
                                                                        ...
                                                                        'necessary for models to train over the '
                                                                        'entirety '
                                                                        'of a dataset, nor evaluate over the entirety '
                                                                        'of a '
                                                                        'test set, to produce useful monitoring '
                                                                        'metrics '
                                                                        'and signals to indicate model health.\n'
                                                                        '\n'
     ...
     'train_steps': ParameterMetadata(ui_display_name='Train Steps',
                                      default_value_reasoning='This defaults to `epochs`, which is a very high '
                                                              ...
                                                              'stopping criteria before reaching the absolute end of '
                                                              'the '
                                                              'training runway.',
                                      example_value=None,
                                      ...
                                      suggested_values_reasoning="Usually it's sensible to leave this very high and "
                                                                 "rely on a solid early stopping policy to dictate "
                                                                 "when the model should stop training. Some models "
                                                                 "and hyperparameter configurations require many "
                                                                 "epochs through the dataset to converge while others "
                                                                 "converge before a single epoch through the data.",
                                      commonly_used=False,
                                      expected_impact=ExpectedImpact.HIGH,
                                      literature_references=None,
                                      internal_only=False),
     'validation_field': ParameterMetadata(ui_display_name='Validation Field',
                                           default_value_reasoning='Concrete evaluation metrics are usually better '
                                                                   'than loss, the penalty for a bad prediction, '
                                                                   'which is only a proxy for prediction correctness.',
                                           example_value=None,
                                           related_parameters=['validation_field', 'validation_metric'],
                                           other_information=None,
                                           description_implications='This parameter affects 1) what the early '
                                                                    'stopping policy looks at to determine when to '
                                                                    'early stop and 2) hyperparameter optimization '
