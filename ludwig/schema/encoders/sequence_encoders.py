...
class StackedCNNConfig(schema_utils.BaseMarshmallowConfig):
    ...
    strides: Optional[int] = schema_utils.PositiveInteger(
        default=1,
    ...
    dilation_rate: Optional[int] = schema_utils.PositiveInteger(
        default=1,
    ...
    pool_strides: Optional[int] = schema_utils.PositiveInteger(
        default=None,
        description="Factor to scale down.",
    )

    pool_padding: Optional[str] = schema_utils.StringOptions(
        ["valid", "same"],
        default="same",
        description="Padding to use.",
    )
