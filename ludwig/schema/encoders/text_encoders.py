...
class ALBERTConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "albert",
        description=ENCODER_METADATA["ALBERTEncoder"]["type"].long_description,
    )
...
class MT5Config(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "mt5",
        description=ENCODER_METADATA["MT5Encoder"]["type"].long_description,
    )
...
class XLMRoBERTaConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "xlmroberta",
        description=ENCODER_METADATA["XLMRoBERTaEncoder"]["type"].long_description,
    )
...
class BERTConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "bert",
        description=ENCODER_METADATA["BERTEncoder"]["type"].long_description,
    )
...
class XLMConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "xlm",
        description=ENCODER_METADATA["XLMEncoder"]["type"].long_description,
    )
...
class GPTConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "gpt",
        description=ENCODER_METADATA["GPTEncoder"]["type"].long_description,
    )
...
class GPT2Config(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "gpt2",
        description=ENCODER_METADATA["GPT2Encoder"]["type"].long_description,
    )
...
class RoBERTaConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "roberta",
        description=ENCODER_METADATA["RoBERTaEncoder"]["type"].long_description,
    )
...
class TransformerXLConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "transformer_xl",
        description=ENCODER_METADATA["TransformerXLEncoder"]["type"].long_description,
    )
...
class XLNetConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "xlnet",
        description=ENCODER_METADATA["XLNetEncoder"]["type"].long_description,
    )
...
class DistilBERTConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "distilbert",
        description=ENCODER_METADATA["DistilBERTEncoder"]["type"].long_description,
    )
...
class CTRLConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "ctrl",
        description=ENCODER_METADATA["CTRLEncoder"]["type"].long_description,
    )
...
class CamemBERTConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "camembert",
        description=ENCODER_METADATA["CamemBERTEncoder"]["type"].long_description,
    )
...
class T5Config(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "t5",
        description=ENCODER_METADATA["T5Encoder"]["type"].long_description,
    )
...
class FlauBERTConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "flaubert",
        description=ENCODER_METADATA["FlauBERTEncoder"]["type"].long_description,
    )
...
class ELECTRAConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "electra",
        description=ENCODER_METADATA["ELECTRAEncoder"]["type"].long_description,
    )
...
class LongformerConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "longformer",
        description=ENCODER_METADATA["LongformerEncoder"]["type"].long_description,
    )
...
class AutoTransformerConfig(BaseEncoderConfig):
    ...
    type: str = schema_utils.ProtectedString(
        "auto_transformer",
        description=ENCODER_METADATA["AutoTransformerEncoder"]["type"].long_description,
    )
