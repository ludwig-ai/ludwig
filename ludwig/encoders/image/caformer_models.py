...
default_cfgs = {
    ...
    "caformer_s18_384": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_s18_384.pth", input_size=(3, 384, 384)
    ),
    ...
    "caformer_s18_in21k": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_s18_in21k.pth", num_classes=21841
    ),
    "caformer_s36": _cfg(url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_s36.pth"),
    "caformer_s36_384": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_s36_384.pth", input_size=(3, 384, 384)
    ),
    ...
    "caformer_s36_in21k": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_s36_in21k.pth", num_classes=21841
    ),
    "caformer_m36": _cfg(url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_m36.pth"),
    "caformer_m36_384": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_m36_384.pth", input_size=(3, 384, 384)
    ),
    ...
    "caformer_m36_in21k": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_m36_in21k.pth", num_classes=21841
    ),
    "caformer_b36": _cfg(url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_b36.pth"),
    "caformer_b36_384": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_b36_384.pth", input_size=(3, 384, 384)
    ),
    ...
    "caformer_b36_in21k": _cfg(
        url="https://huggingface.co/sail/dl/resolve/main/caformer/caformer_b36_in21k.pth", num_classes=21841
    ),
}
...
class Attention(nn.Module):
    def __init__(
        self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0.0, proj_drop=0.0, proj_bias=False, **kwargs
    ):
        super().__init__()
...
DOWNSAMPLE_LAYERS_FOUR_STAGES = [
    partial(
        Downsampling, kernel_size=7, stride=4, padding=2, post_norm=partial(LayerNormGeneral, bias=False, eps=1e-6)
    ),
    partial(
        Downsampling,
        kernel_size=3,
...
class MetaFormer(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        stem = nn.Sequential(nn.Conv2d(in_chans, dims[0], kernel_size=4, stride=4), norm_layers(dims[0]))
        self.downsample_layers.append(stem)
        for i in range(3):
            downsample_layer = nn.Sequential(
                nn.Conv2d(dims[i], dims[i + 1], kernel_size=2, stride=2), norm_layers(dims[i + 1])
            )
                ...
                *[
                    MetaFormerBlock(
                        ...
                        layer_scale_init_value=(
                            layer_scale_init_values[i]
                            if isinstance(layer_scale_init_values, (list, tuple))
                            else layer_scale_init_values
                        ),
                        res_scale_init_value=(
                            res_scale_init_values[i]
                            if isinstance(res_scale_init_values, (list, tuple))
                            else res_scale_init_values
                        ),
                    )
