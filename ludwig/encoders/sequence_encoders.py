...
class SequencePassthroughEncoder(SequenceEncoder):
    ...
    def call(self, input_sequence, training=True, mask=None):
        """
...
class SequenceEmbedEncoder(SequenceEncoder):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        """
        # ================ Embeddings ================
        embedded_sequence = self.embed_sequence(inputs, training=training, mask=mask)
...
class ParallelCNN(SequenceEncoder):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # ================ Conv Layers ================
        hidden = self.parallel_conv1d(hidden, training=training, mask=mask)
...
class StackedCNN(SequenceEncoder):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # ================ Conv Layers ================
        hidden = self.conv1d_stack(hidden, training=training, mask=mask)
...
class StackedParallelCNN(SequenceEncoder):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # ================ Conv Layers ================
        hidden = self.parallel_conv1d_stack(hidden, training=training, mask=mask)
...
class StackedRNN(SequenceEncoder):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # ================ Recurrent Layers ================
        hidden, final_state = self.recurrent_stack(hidden, training=training, mask=mask)
...
class StackedCNNRNN(SequenceEncoder):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # ================ Recurrent Layers ================
        hidden, final_state = self.recurrent_stack(hidden, training=training)
