...
class SequenceEmbedEncoder(SequenceEncoder):
    ...
    def output_shape(self) -> torch.Size:
        ...
        # override LudwigModule method because by default it generates a
        # tensor of type FloatTensor.
        # embedding encoder expects tensor to be of torch.int*
        output_tensor = self.forward(torch.zeros(2, *self.input_shape,
                                                 dtype=torch.int32))
        # output_tensor is a dictionary with keys:
        #   encoder_output: tensor generated by encoder
        # extract dimension for tensor generated by the encoder
