...
_DATASETPROFILE_FEATUREPROFILESENTRY = _descriptor.Descriptor(
  ...
  full_name='ludwigwhy.DatasetProfile.FeatureProfilesEntry',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ludwigwhy.DatasetProfile.FeatureProfilesEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='ludwigwhy.DatasetProfile.FeatureProfilesEntry.value', index=1,
...
_DATASETPROFILE = _descriptor.Descriptor(
  name='DatasetProfile',
  full_name='ludwigwhy.DatasetProfile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='ludwigwhy.DatasetProfile.timestamp', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='num_examples', full_name='ludwigwhy.DatasetProfile.num_examples', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='size_bytes', full_name='ludwigwhy.DatasetProfile.size_bytes', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='feature_profiles', full_name='ludwigwhy.DatasetProfile.feature_profiles', index=3,
...
_FEATUREPROFILE = _descriptor.Descriptor(
  name='FeatureProfile',
  full_name='ludwigwhy.FeatureProfile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='whylogs_metrics', full_name='ludwigwhy.FeatureProfile.whylogs_metrics', index=0,
...
DatasetProfile = _reflection.GeneratedProtocolMessageType('DatasetProfile', (_message.Message,), {
  ...
  'FeatureProfilesEntry' : _reflection.GeneratedProtocolMessageType('FeatureProfilesEntry', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:ludwigwhy.DatasetProfile.FeatureProfilesEntry)
    })
  ,
  'DESCRIPTOR' : _DATASETPROFILE,
  '__module__' : 'ludwig.profiling.proto.dataset_profile_pb2'
  # @@protoc_insertion_point(class_scope:ludwigwhy.DatasetProfile)
  })
...
FeatureProfile = _reflection.GeneratedProtocolMessageType('FeatureProfile', (_message.Message,), {
  ...
  '__module__' : 'ludwig.profiling.proto.dataset_profile_pb2'
  # @@protoc_insertion_point(class_scope:ludwigwhy.FeatureProfile)
  })
