...
if response.status_code == 200:
    ...
    print(
        "\nError during predictions, error code: ",
...
# construct URL
batch_predict_url = "".join(
    ["http://", LUDWIG_HOST, ":", LUDWIG_PORT, "/batch_predict"]
)
...
try:
    response = requests.post(
        batch_predict_url, data={"dataset": prediction_request_json}
    )
except requests.exceptions.ConnectionError as e:
    print(e)
