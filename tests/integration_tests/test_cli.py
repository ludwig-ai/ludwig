...
def _run_ludwig(command, csv_filename, **ludwig_kwargs):
...
def test_train_cli_defaults(csv_filename):
    """Test training using `ludwig train` without overriding any args."""
    _run_ludwig('train', csv_filename)
