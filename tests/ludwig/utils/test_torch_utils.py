...
from ludwig.utils.torch_utils import sequence_length_2D, sequence_length_3D, _get_torch_init_params, \
    _set_torch_init_params, initialize_pytorch
...
@patch('ludwig.utils.torch_utils.torch')
def test_initialize_pytorch_with_horovod_bad_local_rank(mock_torch,
                                                        mock_warnings):
