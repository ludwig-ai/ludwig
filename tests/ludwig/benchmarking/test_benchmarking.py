...
def get_benchamrking_config_validity_pair():
    ...
    invalid_bench_configs = [os.path.join(local_dir, "example_files", "invalid", config_fp) for config_fp in
                             os.listdir(os.path.join(local_dir, "example_files", "invalid"))]
    valid_bench_configs = [os.path.join(local_dir, "example_files", "valid", config_fp) for config_fp in
                           os.listdir(os.path.join(local_dir, "example_files", "valid"))]
