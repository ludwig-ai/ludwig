...
@pytest.mark.parametrize(
    ...
    [
        ('2012-02-26T13:51:50.417-07:00', None,
         [2012, 2, 26, 6, 57, 13, 51, 50, 49910]),
...
def test_date_to_list(date_str, datetime_format, expected_list):
    ...
    assert date_feature.DateInputFeature.date_to_list(
        date_str, datetime_format, preprocessing_parameters) == expected_list
...
def test_date_to_list__UsesFillValueOnInvalidDate():
    ...
    assert (date_feature.DateInputFeature.date_to_list(
        invalid_date_str, datetime_format, preprocessing_parameters) ==
