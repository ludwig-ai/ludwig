...
// const maxRotX=op.inValue("max rot x",0);
    ...
    function onmousemove(event) {
        ...
        } else if (event.which == 2 && allowZooming.get()) {
...
Ops.Gl.Shader.BasicMaterial = function () {
    ...
    {
        // rgba colors
        var r = op.addInPort(new CABLES.Port(op, "r", CABLES.OP_PORT_TYPE_VALUE, {
            display: 'range',
            colorPick: 'true'
        }));
...
CABLES.OPS["85ae5cfa-5eca-4dd8-8b30-850ac34f7cd5"] = {
    f: Ops.Gl.Shader.BasicMaterial,
    objName: "Ops.Gl.Shader.BasicMaterial"
};
...
Ops.Gl.ShaderEffects.VertexDisplacementMap = function () {
    ...
    var meth = op.addInPort(new CABLES.Port(this, "mode", CABLES.OP_PORT_TYPE_VALUE, {
        display: 'dropdown',
...
CABLES.OPS["94ffa0de-2926-4d02-842e-a1ad6f5846c2"] = {
    f: Ops.Gl.ShaderEffects.VertexDisplacementMap,
    objName: "Ops.Gl.ShaderEffects.VertexDisplacementMap"
};
    ...
    function updateResolution() {
        ...
        if (texOut.get())
            if (!texOut.get().isPowerOfTwo()) {
                ...
                op.uiAttr({hint: null, warning: null});
            }
...
CABLES.OPS["81253441-cc73-42fa-b903-6d23806873d9"] = {
    f: Ops.Gl.TextureEffects.Noise.Noise,
    objName: "Ops.Gl.TextureEffects.Noise.Noise"
};
