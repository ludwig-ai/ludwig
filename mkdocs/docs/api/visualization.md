...
- __train_stats_per_model__ (train_stats_per_model: List containing train statistics per mode):train_stats_per_model: List containing train statistics per model
- __field__ (field: Prediction field containing ground truth):field: Prediction field containing ground truth.
...
- __test_stats_per_model__ (test_stats_per_model: List containing train statistics per mode):test_stats_per_model: List containing train statistics per model
- __field__ (field: Prediction field containing ground truth):field: Prediction field containing ground truth.
- __model_names__ (model_names: List of the names of the models to use as labels):model_names: List of the names of the models to use as labels.
- __output_directory__ (output_directory: Directory where to save plots):output_directory: Directory where to save plots.
     If not specified, plots will be displayed in a window
...
- __probabilities_per_model__ (probabilities_per_model: List of model probabilitie):probabilities_per_model: List of model probabilities
- __ground_truth__ (ground_truth: NumPy Array containing computed model ground trut):ground_truth: NumPy Array containing computed model ground truth
   data for target prediction field based on the model metadata
- __top_n_classes__ (top_n_classes: List containing the number of classes to plo):top_n_classes: List containing the number of classes to plot
...
- __predictions_per_model__ (predictions_per_model: List containing the model prediction):predictions_per_model: List containing the model predictions
   for the specified field
- __ground_truth__ (ground_truth: NumPy Array containing computed model ground trut):ground_truth: NumPy Array containing computed model ground truth
   data for target prediction field based on the model metadata
- __metadata__ (metadata: Model's input metadat):metadata: Model's input metadata
- __field__ (field: field containing ground trut):field: field containing ground truth
- __labels_limit__ (labels_limit: Maximum numbers of labels):labels_limit: Maximum numbers of labels.
     If labels in dataset are higher than this number, "rare" label
- __model_names__ (model_names: List of the names of the models to use as labels):model_names: List of the names of the models to use as labels.
- __output_directory__ (output_directory: Directory where to save plots):output_directory: Directory where to save plots.
...
- __top_n_classes__ (top_n_classes: List containing the number of classes to plo):top_n_classes: List containing the number of classes to plot
- __labels_limit__ (labels_limit: Maximum numbers of labels):labels_limit: Maximum numbers of labels.
- __subset__ (subset: Type of the subset filterin):subset: Type of the subset filtering
- __model_names__ (model_names: List of the names of the models to use as labels):model_names: List of the names of the models to use as labels.
- __output_directory__ (output_directory: Directory where to save plots):output_directory: Directory where to save plots.
     If not specified, plots will be displayed in a window
- __file_format__ (file_format: File format of output plots - pdf or p):file_format: File format of output plots - pdf or png
...
- __probabilities_per_model__ (probabilities_per_model: List of model probabilitie):probabilities_per_model: List of model probabilities
- __ground_truths__ (ground_truths: List of NumPy Arrays containing computed model groun):ground_truths: List of NumPy Arrays containing computed model ground
       truth data for target prediction fields based on the model
       metadata
- __threshold_fields__ (threshold_fields: List of fields for 2d threshol):threshold_fields: List of fields for 2d threshold
- __labels_limit__ (labels_limit: Maximum numbers of labels):labels_limit: Maximum numbers of labels.
     If labels in dataset are higher than this number, "rare" label
- __model_names__ (model_names: Name of the model to use as label):model_names: Name of the model to use as label.
- __output_directory__ (output_directory: Directory where to save plots):output_directory: Directory where to save plots.
     If not specified, plots will be displayed in a window
- __file_format__ (file_format: File format of output plots - pdf or p):file_format: File format of output plots - pdf or png
...
- __probabilities_per_model__ (probabilities_per_model: List of model probabilitie):probabilities_per_model: List of model probabilities
- __ground_truth__ (ground_truth: List of NumPy Arrays containing computed mode):ground_truth: List of NumPy Arrays containing computed model
...
- __metrics__ (f1, precision, recall):metrics: metrics to dispay (f1, precision, recall,
            accuracy)
- __positive_label__ (positive_label: Label of the positive clas):positive_label: Label of the positive class
- __model_names__ (model_names: List of the names of the models to use as labels):model_names: List of the names of the models to use as labels.
- __output_directory__ (output_directory: Directory where to save plots):output_directory: Directory where to save plots.
     If not specified, plots will be displayed in a window
- __file_format__ (file_format: File format of output plots - pdf or p):file_format: File format of output plots - pdf or png
...
- __field__ (field: Prediction field containing ground truth):field: Prediction field containing ground truth.
- __top_n_classes__ (top_n_classes: List containing the number of classes to plo):top_n_classes: List containing the number of classes to plot
- __normalize__ (normalize: Flag to normalize rows in confusion matri):normalize: Flag to normalize rows in confusion matrix
- __model_names__ (model_names: List of the names of the models to use as labels):model_names: List of the names of the models to use as labels.
- __output_directory__ (output_directory: Directory where to save plots):output_directory: Directory where to save plots.
     If not specified, plots will be displayed in a window
- __file_format__ (file_format: File format of output plots - pdf or p):file_format: File format of output plots - pdf or png
